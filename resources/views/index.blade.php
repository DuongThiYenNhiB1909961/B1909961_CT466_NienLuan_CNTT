                ...
                <li class="nav-item">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                            ...
                            <div class=" text-lg font-semibold"><a class="nav-link " href="#">Login</a></div>
                    </div>
                </li>
              </ul>
        </div>
                  ...
                  <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-check-fill" viewBox="0 0 16 16">
                          ...
                          <div class=" text-lg font-semibold"><a class="nav-link" href="#">Home </a></div>
                        </div>
                    </li>
                    <li class="nav-item ml-2">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-heart-fill" viewBox="0 0 16 16">
                              ...
                              <div class=" text-lg font-semibold"><a class="nav-link" href="">Introduce</a></div>
                            </div>
                    </li>
