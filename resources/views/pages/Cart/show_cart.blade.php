                  ...
                  ?>
                      <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="text-warning bi bi-journal-bookmark-fill" viewBox="0 0 16 16">
                          ...
                          <div class=" text-lg font-semibold"><a class="text-warning nav-link" href="{{URL::to('/checkout')}}"><b>Checkout</b> </a></div>
                      </div>
                  <?php
                      }else{
                  ?>
                      <div class="flex items-center">
                        ...
                        <div class=" text-lg font-semibold"><a class="text-warning nav-link " href="{{URL::to('/login-checkout')}}"><b>Checkout</b></a></div>
                      </div>
                  <?php
                  }
                  ?>
