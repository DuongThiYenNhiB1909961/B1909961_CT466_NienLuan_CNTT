        ...
        <div>
            <ul class="nav justify-content-end">
                <li class="nav-item">
                    <div class="flex items-center">
                        ...
                        <div class=" text-lg font-semibold"><a class="nav-link" href="{{URL::to('/checkout')}}">Account</a></div>
                    </div>
                </li>
                <?php
                ...
                <li class="nav-item">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="text-warning bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                            ...
                            <div class=" text-lg font-semibold"><a class="nav-link " href="{{URL::to('/pill')}}">Checkout</a></div>
                    </div>
                </li>
                <?php
                    }else {
            ...
            <li class="nav-item">
                <div class="flex items-center">
                    ...
                    <div class=" text-lg font-semibold"><a class="nav-link" href="show-cart">Cart</a></div>
                </div>
            </li>
            <?php
                }else{
            ...
            <li class="nav-item">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="text-warning bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M6 3.5a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 0-1 0v2A1.5 1.5 0 0 0 6.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-8A1.5 1.5 0 0 0 5 3.5v2a.5.5 0 0 0 1 0v-2z"/>
                        <path fill-rule="evenodd" d="M11.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H1.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"/></svg>
                        <div class=" text-lg font-semibold"><a class="nav-link " href="{{URL::to('/login-checkout')}}">Cart</a></div>
                </div>
            </li>
            <?php
            }
            ?>
                ...
                <li class="nav-item">
                    <div class="flex items-center">
                        ...
                        <div class=" text-lg font-semibold"><a class="nav-link " href="{{URL::to('/logout')}}">Logout</a></div>
                    </div>
                </li>
                <?php
                    }else{
                  ...
                  <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown ml-2">
                        <div class="flex items-center">
                            ...
                            <div class=" text-lg font-semibold"><a class="nav-link" href="product">
                                Products</a></div>
                            </div>
                    </li>
                    <li class="nav-item ml-2">
