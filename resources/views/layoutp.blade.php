...
<html lang="en">
    <head>
        ...
        <style>
            body, html {
                ...
                background: url(https://png.pngtree.com/thumb_back/fw800/background/20190222/ourmid/pngtree-simple-pink-bubble-universal-background-material-backgroundposter-backgroundbanner-backgroundpsd-image_52079.jpg) no-repeat 0px 0px;
    ...
    <body class="antialiased container">
        ...
        <div class="col-sm-10">
            <ul class="nav justify-content-end">
                ...
                <li class="nav-item">
                    <div class="flex items-center">
                        ...
                        <div class=" text-lg font-semibold"><a class="nav-link text-danger" href="{{URL::to('/checkout')}}"><b>Checkout</b></a></div>
                    </div>
                </li>
                <?php
                ...
                <li class="nav-item">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="text-warning bi bi-journal-bookmark-fill" viewBox="0 0 16 16">
                          ...
                          <div class=" text-lg font-semibold"><a class="nav-link text-danger" href="{{URL::to('/pill')}}"><b>Checkout</b></a></div>
                    </div>
                </li>
                <?php
                    }else {
                ...
                <li class="nav-item">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="text-warning bi bi-journal-bookmark-fill" viewBox="0 0 16 16">
                          ...
                          <div class=" text-lg font-semibold"><a class="nav-link text-danger" href="{{URL::to('/login-checkout')}}"><b>Checkout</b></a></div>
                    </div>
                </li>
                <?php
                }
            ...
            <li class="nav-item">
                <div class="flex items-center">
                    ...
                    <div class=" text-lg font-semibold"><a class="nav-link  text-danger" href="show-cart"><b>Cart</b></a></div>
                </div>
            </li>
            <?php
                }else{
            ...
            <li class="nav-item">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="text-warning bi bi-cart-fill" viewBox="0 0 16 16">
                      ...
                      <div class=" text-lg font-semibold"><a class="nav-link text-danger " href="{{URL::to('/login-checkout')}}"><b>Cart</b></a></div>
                </div>
            </li>
            <?php
            }
            ?>
                ...
                <li class="nav-item">
                    <div class="flex items-center">
                        ...
                        <div class=" text-lg font-semibold"><a class="nav-link  text-danger" href="{{URL::to('/logout')}}"><b>Logout</b></a></div>
                    </div>
                </li>
                <?php
                    }else{
                ...
                <li class="nav-item">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="text-warning bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                            ...
                            <div class=" text-lg font-semibold"><a class="nav-link  text-danger" href="{{URL::to('/login-checkout')}}"><b>Login</b></a></div>
                    </div>
                </li>
                <?php
                }
        ...
        <header class="row">
            <nav class="navbar navbar-expand-lg navbar-light bg-light col-sm-8">
                  ...
                  <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="text-warning bi bi-house-check-fill" viewBox="0 0 16 16">
                          ...
                          <div class=" text-lg font-semibold"><a class="nav-link text-danger" href="index"><b>Home </b></a></div>
                        </div>
                    </li>
                    <li class="nav-item ml-2">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="text-warning bi bi-bookmark-heart-fill" viewBox="0 0 16 16">
                              ...
                              <div class=" text-lg font-semibold"><a class="nav-link text-danger" href="introduce"><b>Introduce</b> </a></div>
                        </div>
                    </li>
                    <li class="nav-item dropdown ml-2">
                        <div class="flex items-center">
                            ...
                            <div class=" text-lg font-semibold"><a class="nav-link text-danger" href="product">
                                <b>Products</b></a></div>
                            </div>
                    </li>
                    <li class="nav-item ml-2">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="text-warning bi bi-chat-left-text-fill" viewBox="0 0 16 16">
                              ...
                              <div class=" text-lg font-semibold"><a class="nav-link text-danger" href="contact"><b>Contact</b></a></div>
                            </div>
                    </li>
                  </ul>
                </div>
        ...
        @yield('content')
        <footer class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0 pt-2 mt-2 rouded bg-white">
