...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased container">
                  ...
                  <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown ml-2">
                        <div class="flex items-center">
                            ...
                            <div class=" text-lg font-semibold"><a class="nav-link dropdown-toggle" href="product" role="button" data-toggle="dropdown" aria-expanded="false">
                                Products</a></div>
                            </div>
                    </li>
                    <li class="nav-item ml-2">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-left-text-fill" viewBox="0 0 16 16">
                              ...
                              <div class=" text-lg font-semibold"><a class="nav-link" href="contact">Contact</a></div>
                            </div>
                    </li>
                  </ul>
                </div>
        ...
        <div class="pt-1 relative min-h-screen bg-gray-100 dark:bg-gray-900 py-4 sm:pt-0">
                ...
                <div class="row">
                    <div class="col text-center m-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-chat-left-text-fill" viewBox="0 0 16 16">
                          ...
                          <div style="font-size: 2em" class=" text-lg font-semibold"><a class="nav-link" href="contact"><b>CONTACT US</b></a></div>
                        </div>
                    {{-- <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20%" height="20%" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
                            <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
                          </svg>
                          <div style="font-size: 3em" class=" text-lg font-semibold"><a class="nav-link " href="contact"><b>CONTACT US</b></a></div>
                    </div> --}}
                </div>
                <div class="pt-3">
                    <div class="row ">
                        <div class="bg-gradient-dark ml-2">
                            <div class="col-sm h-5 ">
                                <i><b>Online</b></i>
                      ...
                      <div class="col-sm">
                        ...
                        <p>Shop 2: Số 223, đường Nguyễn Văn Cừ Nối Dài, phường An Khánh, quận Ninh Kiều, tp Cần Thơ</p>
                      </div>
                      <div class="col-sm">
                        <i><b>Time</b></i>
